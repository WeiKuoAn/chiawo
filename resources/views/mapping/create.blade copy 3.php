                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="canvas-wrapper" style="position: relative;">
                                        ...
                                        <div class="canvas-container" id="canvasContainerText3">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $('#addLineBtn').click(function() {
            ...
            if (orientation === 'horizontal') {
                ...
                ctx2.fillText(
                    `${startY} mm`,
                    (startX) * mmToPx * scaleFactor, // 偏左顯示
                    (startY * mmToPx * scaleFactor) / 2 // 垂直方向中間位置
                );
            } else {
                ...
                ctx2.fillText(
                    `${lineLength} mm`,
                    (startX - 50) * mmToPx * scaleFactor,
                    (startY + lineLength / 2) * mmToPx * scaleFactor
                );
