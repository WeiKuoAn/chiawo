                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="email" name="email" id="emailaddress" required="" placeholder="Enter your email" value="test@test.com">
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p> <a href="{{ route('password.request') }}" class="text-white-50 ms-1">Forgot your
                                    password?</a></p>
                            <p class="text-white-50">Don't have an account? <a href="#" class="text-white ms-1"><b>Sign
                                        Up</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
